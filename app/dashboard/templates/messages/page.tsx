    ...
    const [templates, setTemplates] = useState<Template[]>([
        {
            ...
            content: 'Hi {name}, thank you for reaching out! How can I help you today?'
        },
        {
            id: '2',
            name: 'Business Hours',
            content: 'Our business hours are Monday to Friday, 9 AM to 5 PM. We\'ll get back to you during our working hours.'
        }
    ]);
    ...
    return (
        <div>
            ...
            <p className="text-muted-foreground mb-6">
                Create and manage templates for direct message responses.
            </p>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            You can use variables like {'{name}'} to personalize your messages.
                                        </p>
                                    </div>
                                </div>
                            ) : (
